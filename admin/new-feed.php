...
<div class="container" >
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="file_name" name="file_name" placeholder="Input file name here..." required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" id="template" name="template" placeholder="Google Shopping " readonly>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
  ...
  <br>
  <div class="row">
    <input type="submit" value="Create Feed" name="create">
  </div>
  <div id='loader' style='display: none;'>
  <img src='images/loading.gif' width='15px' height='15px'> processing please wait...
</div>
  <div id="msg" style="display: none;background:lightgreen;padding: 5px;text-overflow: ellipsis;
        overflow: hidden;
        width: 190px;"  class="alert alert-danger"></div>
  </form>
